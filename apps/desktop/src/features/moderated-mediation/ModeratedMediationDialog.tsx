...
import { moderatedMediationSpec } from '@method-studio/analysis-specs';
...
/**
 * Moderated Mediation Analysis dialog (PROCESS Model 7/14).
...
export function useModeratedMediationDialog() {
