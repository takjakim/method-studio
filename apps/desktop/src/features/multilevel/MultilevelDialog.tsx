...
/**
 * Hierarchical Linear Modeling (HLM) / Multilevel Analysis dialog.
 * Uses JamoviStyleDialog with drag-and-drop support.
 */
export function MultilevelDialog({
  isOpen,
  onClose,
  onRun,
  variables,
...
export function useMultilevelDialog() {
